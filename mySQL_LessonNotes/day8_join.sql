...
-----------------------------------------------------------------------------------*/ 
	...
	select per.personel_isim, bl.bolum_isim
    from bolumler as bl 
    join personel as per
    on  bl.bolum_id=per.bolum_id
    where bolum_isim in('satis','muhasebe')
    order by bl.bolum_isim,per.personel_isim;
...
------------------------------------------------------------------------------*/ 
    ...
    where b.BOLUM_ISIM in('satis','muhasebe','depo')
...
------------------------------------------------------------------------------*/   
	...
	select b.bolum_isim, p.personel_isim,  p.maas,(select personel_isim from personel 
																		where p.mudur_id=personel_id) as mudur_ismi
    from bolumler b
