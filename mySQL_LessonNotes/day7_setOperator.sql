...
union  -- union distinct seklinde calisir
select isim from personel where sirket ='Ford'
union  -- union all tekrarlilarida getirir
select isim from personel where sirket ='Tofas';

/* -----------------------------------------------------------------------------
  ORNEK4: 5000’den az maas alanlarin bilgilerini ve Honda calisani olmayanlarin bilgilerini
