...
INSERT INTO calisanlar VALUES('10008', null, 5000, '2018-04-14'); -- null unique engel olusturmaz 2. kez null benzersizlik kisitlamasini bozmaz
...
INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); -- Cunku CAN unique olmadi zaten var
INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14');-- '' maaş integer olduğu için hata verir
INSERT INTO calisanlar VALUES('', 'osman', 2000, '2018-04-14');-- id string olduğu için '' hiçlik anlamna gelir ve kabul eder.
INSERT INTO calisanlar VALUES('10002', 'ayse Yilmaz', 12000, '2018-04-14');-- id tekrarli olamaz
...
----------------------------------------------------------------*/
    ...
    -- parent tablo'da olmayan child a ekleme yapamayiz
    -- FK'ye null değeri atanabilir. 
    INSERT INTO adresler VALUES(NULL,'Ağa Sok', '30.Cad.','Antep');
    
    select * from adresler;
    -- baglantili tablolarda child silinmeden parent silinmez
    drop table calisanlar; -- child silinmedeigi icin parent silinmez 
    drop table adresler;
